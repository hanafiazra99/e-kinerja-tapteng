...
if (isset($_POST['TombolSuntingJamKerja'])) {
	...
	if (!in_array("fail", $proses_check)) {
		pop_up_direct(BASE_URL, ABSENSI_URL . 'jadwal/jam-pulang/', 'Berhasil', 'Berhasil mengubah jam pulang.', 'modal-success');
	} else {
		
		pop_up_direct(BASE_URL, ABSENSI_URL . 'jadwal/jam-pulang/', 'Gagal', 'Terjadi kesalahan pada sistem, laporkan ini pada pihak pengembang.', 'modal-danger');
	}
