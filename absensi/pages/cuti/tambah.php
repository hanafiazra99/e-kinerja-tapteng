...
?>
            ...
            <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahCuti" method="post" action="<?php echo ABSENSI_URL; ?>controllers/c-cuti.php" enctype="multipart/form-data">
                        <div class="box-body">
...
?>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label class="col-sm-2 control-label">Masa Cuti</label>
                                <div class="col-sm-10">
                                    <div class="input-group">
                                      <div class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
                                      </div>
                                      <input type="text" class="form-control" data-date-format='yyyy-mm-dd' name="masa_cuti" id="reservation">
                                    </div>
                                </div>
                                <!-- /.input group -->
                              </div>
