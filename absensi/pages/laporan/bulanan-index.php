...
$conn = req_data($koneksi, 'absen');

$breadcrumb = array('Rekap Bulanan');
					...
					<form action="excel" method="post">
						...
						<div class="box-body">
							...
							<div class="form-horizontal">
								...
								<div class="form-group" id="content_for_unit_organisasi">
									<label for="nama" class="col-sm-2 control-label">Tanggal</label>
									<div class="col-sm-10">
										<input type="text" id="tanggal" name="periode" class="form-control">
									</div>
								</div>
