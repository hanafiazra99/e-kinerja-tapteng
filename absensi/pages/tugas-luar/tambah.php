...
require "../../controllers/c-tugas-luar.php";

cek_session();
$user_data = user_data($koneksi);
$breadcrumb = array('Tugas Luar', 'Tambah');
$check = ($_SESSION['role'] == '10' ? '' : 'test');
check_page_request($check, ABSENSI_URL . 'cuti');
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahTugasLuar" method="post" action="<?php echo ABSENSI_URL; ?>controllers/c-tugas-luar.php" enctype="multipart/form-data">
                        <div class="box-body">
...
?>
                             ...
                             <div class="form-group">
                                <label class="col-sm-2 control-label">Masa Tugas Luar</label>
                                <div class="col-sm-10">
                                    <div class="input-group">
                                      <div class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
                                      </div>
                                      <input type="text" class="form-control" data-date-format='yyyy-mm-dd' name="masa_tugas_luar" id="reservation">
                                    </div>
                                </div>
                                <!-- /.input group -->
                              </div>
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahTugasLuar" name="TombolTambahTugasLuar">Simpan</button>
...
echo '
         ...
         ';
template_js();
echo '<script src="' . RESOURCES_URL . 'js-for/absensi/data-tugas-luar/' . basename($_SERVER['PHP_SELF'], '.php') . '.js"></script>';
?>
</body>
