...
require "../../../controllers/c-jam-pulang.php";
			...
			<section class="content">
				<div class="box box-blue">
                    <div class="box-header with-border">
                        <h3 class="box-title">Daftar Jam Pulang</h3>
...
echo '
 ...
 ';
template_js();
echo '<script src="' . RESOURCES_URL . 'js-for/absensi/jadwal/jam-pulang/' . basename($_SERVER['PHP_SELF'], '.php') . '.js"></script>';
?>
</body>
