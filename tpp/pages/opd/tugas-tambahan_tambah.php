...
$breadcrumb = array($data_opd['nama'], 'Besaran TPP', $data['nama_jabatan'], 'Tugas Tambahan', 'Tambah');
?>
<!DOCTYPE html>
<html>
...
?>
			...
			<section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahTugasTambahan" method="post" action="<?php echo TPP_URL; ?>controllers/c-opd.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <a href="<?php echo TPP_URL . 'opd/' . $data_opd['id'] . '/' . $data['id'] . '/'; ?>" class="btn btn-sm btn-default" >Batal</a>
                                </div>
                            </div>
                        </div>
                    </form>
