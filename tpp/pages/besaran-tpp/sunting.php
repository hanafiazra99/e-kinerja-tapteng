...
$breadcrumb = array($data['nama_jabatan'], 'Sunting');
?>
<!DOCTYPE html>
<html>
...
?>
			...
			<section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormSuntingBesaranTPP" method="post" action="<?php echo TPP_URL; ?>controllers/c-besaran-tpp.php" enctype="multipart/form-data">
                        <div class="box-body">
