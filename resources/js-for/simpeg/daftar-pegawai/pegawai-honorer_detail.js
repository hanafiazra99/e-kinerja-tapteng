$(document).ready(function () {
    ...
    var table1 = $('#daftar_data_1').DataTable({
        ...
        "serverSide": true,
        "ordering": false,
        "ajax": RESOURCES_URL + "tabel/simpeg/daftar-pegawai/riwayat-kerja-honorer_data.php?pegawai=" + pegawai,
        lengthMenu: [
            [5, 10, 25, 100, -1],
            [5, 10, 25, 100, "All"]
        ],
        ...
        buttons: [{
            ...
            action: function (e, dt, node, config) {
                document.location.href = SIMPEG_URL + 'daftar-pegawai/pegawai-honorer/' + pegawai + '/riwayat-kerja/tambah/';
            },
