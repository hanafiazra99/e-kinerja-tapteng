...
$(document).ready(function () {
    $(".select2").select2();
    $('#FormTambahHukumanDisiplin').bootstrapValidator({
        live: 'disabled',
    ...
    $("#tingkat_hukuman").change(function () {
        var tingkat_hukuman = $(this).val();

        if (tingkat_hukuman == '3') {
            $("#container_diberhentikan").removeAttr("style");
        } else {
            $("#container_diberhentikan").css("display", "none");
        }
    });
});