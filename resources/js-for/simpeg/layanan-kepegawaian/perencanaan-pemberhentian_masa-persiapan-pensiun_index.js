$(document).ready(function () {
    ...
    var table1 = $('#daftar_data_1').DataTable({
        ...
        "serverSide": true,
        "ordering": false,
        "ajax": RESOURCES_URL + "tabel/simpeg/layanan-kepegawaian/masa-persiapan-pensiun_data.php" + (role == '10' ? "?opd=" + user_opd : ""),
        lengthMenu: [
            [5, 10, 25, 100, -1],
            [5, 10, 25, 100, "All"]
        ],
        ...
        buttons: [{
            ...
            action: function (e, dt, node, config) {
                document.location.href = SIMPEG_URL + 'layanan-kepegawaian/perencanaan-pemberhentian/masa-persiapan-pensiun/tambah/';
            },
