$(document).ready(function () {
    ...
    var table1 = $('#daftar_data_1').DataTable({
        ...
        "serverSide": true,
        "ordering": false,
        "ajax": RESOURCES_URL + "tabel/simpeg/perubahan-data/riwayat-pendidikan-umum_data.php" + (role == '10' ? "?opd=" + user_opd : ""),
        lengthMenu: [
            [5, 10, 25, 100, -1],
            [5, 10, 25, 100, "All"]
        ],
    ...
    var table2 = $('#daftar_data_2').DataTable({
        ...
        "serverSide": true,
        "ordering": false,
        "ajax": RESOURCES_URL + "tabel/simpeg/perubahan-data/riwayat-pendidikan-umum_usulan.php" + (role == '10' ? "?opd=" + user_opd : ""),
        lengthMenu: [
            [5, 10, 25, 100, -1],
            [5, 10, 25, 100, "All"]
        ],
