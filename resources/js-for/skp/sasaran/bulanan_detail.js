$(document).ready(function () {
    ...
    var table1 = $('#daftar_data_1').DataTable({
        ...
        "serverSide": true,
        "ordering": false,
        "ajax": RESOURCES_URL + "tabel/skp/sasaran/bulanan_kegiatan_data.php?sasaran_bulanan=" + sasaran_bulanan,
        lengthMenu: [
            [5, 10, 25, 100, -1],
            [5, 10, 25, 100, "All"]
        ],
        ...
        buttons: [{
            ...
            action: function (e, dt, node, config) {
                document.location.href = SKP_URL + 'sasaran/' + sasaran + '/bulanan/' + bulanan + '/kegiatan/tambah/';
            },
    ...
    $(document).on('click', 'TombolSerahkanSasaranBulanan', function () {
        var req = "Modal Konfirmasi";
        var judul = $(this).attr("judul");
        var form = $(this).attr("formreq");
        var pertanyaan = $(this).attr("pertanyaan");
