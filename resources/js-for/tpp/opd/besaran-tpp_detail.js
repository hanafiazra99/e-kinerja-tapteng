$(document).ready(function () {
    ...
    var table1 = $('#daftar_data_1').DataTable({
        ...
        "serverSide": true,
        "ordering": false,
        "ajax": RESOURCES_URL + "tabel/tpp/opd/tugas-tambahan_data.php?nama_jabatan=" + nama_jabatan,
        lengthMenu: [
            [5, 10, 25, 100, -1],
            [5, 10, 25, 100, "All"]
        ],
        ...
        buttons: [{
            ...
            action: function (e, dt, node, config) {
                document.location.href = TPP_URL + 'opd/' + opd + '/' + nama_jabatan + '/tugas-tambahan/tambah/';
            },
    ...
    $(document).on('click', 'TombolHapus', function () {
        ...
        $.ajax({
            type: "post",
            url: TPP_URL + "controllers/c-opd.php",
            data: {
                req: req,
                judul: judul,
                form: form,
