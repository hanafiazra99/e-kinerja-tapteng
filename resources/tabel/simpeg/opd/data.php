    ...
    array(
        ...
        'formatter' => function ($d, $row) {
            return '
                                            ...
                                            <TombolHapus judul="Hapus OPD" formreq="HapusOPD" pertanyaan="Anda Yakin Ingin Menghapus OPD Ini?" parameter="id" value="'.$d.'" class="btn btn-xs btn-danger"><i class="fa fa-trash-o"></i></TombolHapus>
										   ';
        }
    ),
);
