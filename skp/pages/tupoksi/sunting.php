...
$data = req_get_where($koneksi, 'opd_struktur_organisasi_tupoksi', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SKP_URL . 'opd/');
$breadcrumb = array($data['tupoksi'], 'Sunting');
?>
<!DOCTYPE html>
<html>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormSuntingTupoksi" method="post" action="<?php echo SKP_URL;?>controllers/c-tupoksi.php" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <?php
                                        echo component_select_option_where($koneksi, 'opd_struktur_organisasi', 'id', 'nama_jabatan', 'nama_jabatan', 'Nama Jabatan', $data['nama_jabatan'], 'opd = "'.$user_data['opd_id'].'"');
                                    ?>
                                </div>
                            </div>
                            <div class="form-group">
