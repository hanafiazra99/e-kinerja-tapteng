			...
			<section class="content">
                <div class="box box-blue">
                    ...
                    <div class="box-footer">
                        <TombolSampaikanPenilaian <?php echo ($data['status'] == 'Belum Disampaikan' ? '' : 'style="display: none;"'); ?> judul="Sampaikan Sasaran" formreq="SampaikanPenilaian" pertanyaan="Anda Yakin Ingin Menyerahkan Sasaran Ini?" parameter="id" value="<?php echo $data['id']; ?>" class="btn btn-sm btn-primary">Sampaikan</TombolSampaikanPenilaian>
                        ...
                        <table id="daftar_data_1" style="width: 100%;" class="table table-bordered">
                            <thead>
                                <tr class="bg-custom">
                                    ...
                                    <th class="text-center">Kuantitas<br>Realisasi/Target</th>
                                    <th class="text-center">Kuantitas<br>Realisasi/Target</th>
                                    <th class="text-center">Output</th>
                                    <th class="text-center">Kualitas<br>Realisasi/Target</th>
                                    <th class="text-center">Kualitas<br>Realisasi/Target</th>
                                    <th class="text-center">Waktu<br>Realisasi/Target</th>
                                    <th class="text-center">Waktu<br>Realisasi/Target</th>
                                    <th class="text-center">Biaya<br>Realisasi/Target</th>
                                    <th class="text-center">Biaya<br>Realisasi/Target</th>
                                </tr>
                            </thead>
                        </table>
