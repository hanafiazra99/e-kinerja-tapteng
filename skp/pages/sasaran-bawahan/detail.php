...
check_status($koneksi, 'skp_sasaran', $_GET['key1']);
...
if ($data['status'] == 'Diperiksa') {
    ?>
                <div class="box box-blue">
                    <div class="box-header with-border">
                        <h3 class="box-title">Form Verifikasi Sasaran</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                        </div>
                    </div>
                    <form class="form-horizontal" id="FormVerifikasiSasaran" method="post" action="<?php echo SKP_URL; ?>controllers/c-sasaran-bawahan.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolVerifikasiSasaran" name="TombolVerifikasiSasaran">Simpan</button>
