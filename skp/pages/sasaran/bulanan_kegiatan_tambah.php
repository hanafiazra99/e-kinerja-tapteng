...
$breadcrumb = array(content_tgl_indo($data_sasaran['p_awal']) . ' - ' . content_tgl_indo($data_sasaran['p_akhir']), 'Bulanan', content_bulan_indo($data['bulan']) . ' ' . $data['tahun'], 'Kegiatan', 'Tambah');
?>
<!DOCTYPE html>
<html>
...
?>
			...
			<section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahSasaranBulananKegiatan" method="post" action="<?php echo SKP_URL; ?>controllers/c-sasaran.php" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="hidden" class="form-control" id="sasaran_bulanan" name="sasaran_bulanan" placeholder="" value="<?php echo $data['id'] ?>" readonly />
<?php
echo component_select_option_where($koneksi, 'v_skp_sasaran_kegiatan', 'id', 'kegiatan', 'kegiatan', 'Kegiatan', '', 'sasaran = "' . $data_sasaran['id'] . '"');
?>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahSasaranBulananKegiatan" name="TombolTambahSasaranBulananKegiatan">Simpan</button>
                                    <a href="<?php echo SKP_URL . 'sasaran/' . $data_sasaran['id'] . '/bulanan/' . $data['id'] . '/'; ?>" class="btn btn-sm btn-default" >Batal</a>
                                </div>
                            </div>
                        </div>
                    </form>
