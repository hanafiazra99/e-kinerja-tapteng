...
$data = req_get_where($koneksi, 'skp_sasaran_kegiatan', 'id = "' . $_GET['key2'] . '"');
$v_data = req_get_where($koneksi, 'v_skp_sasaran_kegiatan', 'id = "' . $_GET['key2'] . '"');
...
$breadcrumb = array(content_tgl_indo($data_sasaran['p_awal']) . ' - ' . content_tgl_indo($data_sasaran['p_akhir']), 'Kegiatan', $v_data['kegiatan'], 'Sunting');
?>
<!DOCTYPE html>
<html>
...
?>
			...
			<section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormSuntingSasaranKegiatan" method="post" action="<?php echo SKP_URL; ?>controllers/c-sasaran.php" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="" class="col-sm-2 control-label">Nama Kegiatan</label>
                                <div class="col-sm-10">
                                    <input type="hidden" class="form-control" id="sasaran" name="sasaran" placeholder="" value="<?php echo $data['sasaran'] ?>" readonly />
                                    <input type="hidden" class="form-control" id="id" name="id" placeholder="" value="<?php echo $data['id'] ?>" readonly />
<?php
echo component_select_option_where($koneksi, 'opd_struktur_organisasi_tupoksi', 'id', 'tupoksi', 'kegiatan', 'Kegiatan', $data['kegiatan'], 'nama_jabatan = "' . $data_bantu['nama_jabatan_id'] . '"');
?>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="output" id="output" placeholder="Output" value="<?php echo $data['output'] ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="waktu" id="waktu" placeholder="Waktu" value="<?php echo $data['waktu'] ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolSuntingSasaranKegiatan" name="TombolSuntingSasaranKegiatan">Simpan</button>
                                    <a href="<?php echo SKP_URL . 'sasaran/' . $data_sasaran['id'] . '/kegiatan/' . $data['id'] . ''; ?>" class="btn btn-sm btn-default" >Batal</a>
                                </div>
                            </div>
                        </div>
                    </form>
