...
$breadcrumb = array(content_tgl_indo($data_sasaran['p_awal']) . ' - ' . content_tgl_indo($data_sasaran['p_akhir']), 'Bulanan', content_bulan_indo($data['bulan']) . ' ' . $data['tahun'], 'Sunting');
?>
<!DOCTYPE html>
<html>
...
?>
			...
			<section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormSuntingSasaranBulanan" method="post" action="<?php echo SKP_URL; ?>controllers/c-sasaran.php" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control" name="periode" id="periode" placeholder="Periode" autocomplete="off" value="<?php echo $data['tahun'] . '-' . $data['bulan'] ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolSuntingSasaranBulanan" name="TombolSuntingSasaranBulanan">Simpan</button>
...
echo '
        <script>
            ...
            var p_awal = "' . date("Y-m", strtotime($data_sasaran['p_awal'])) . '";
            var p_akhir = "' . date("Y-m", strtotime($data_sasaran['p_akhir'])) . '";
        </script>
     ';
template_js();
