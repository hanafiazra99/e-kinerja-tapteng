			...
			<section class="content">
                <div class="box box-blue">
                    ...
                    <div class="box-footer">
                        <TombolSerahkanSasaran <?php echo ($data['status'] == 'Dibuat' ? '' : 'style="display: none;"'); ?> judul="Serahkan Sasaran" formreq="SerahkanSasaran" pertanyaan="Anda Yakin Ingin Menyerahkan Sasaran Ini?" parameter="id" value="<?php echo $data['id']; ?>" class="btn btn-sm btn-primary">Serahkan</TombolSerahkanSasaran>
                        <a value="<?php echo $data['id']; ?>" class="btn btn-sm btn-success">Sunting</a>
                        <TombolHapusSasaran value="<?php echo $data['id']; ?>" class="btn btn-sm btn-danger">Hapus</TombolHapusSasaran>
                ...
                <div class="box box-blue" <?php echo ($data['status'] == 'Dibuat' ? 'style="display: none;"' : ''); ?>>
                    <div class="box-header with-border">
...
echo '
        <script>
            ...
            var status_sasaran = "' . $data['status'] . '";
            var sasaran = "' . $data['id'] . '";
