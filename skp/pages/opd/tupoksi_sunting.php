...
$data = req_get_where($koneksi, 'opd_struktur_organisasi_tupoksi', 'id = "' . $_GET['key2'] . '"');
$data_opd = req_get_where($koneksi, 'opd', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SKP_URL . 'opd/');
$breadcrumb = array($data_opd['nama'], 'Tupoksi', $data['tupoksi'], 'Sunting');
?>
<!DOCTYPE html>
<html>
...
<body class="hold-transition skin-custom sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormSuntingTupoksi" method="post" action="<?php echo SKP_URL;?>controllers/c-opd.php" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <?php
                                        echo component_select_option_where($koneksi, 'opd_struktur_organisasi', 'id', 'nama_jabatan', 'nama_jabatan', 'Nama Jabatan', $data['nama_jabatan'], 'opd = "'.$data_opd['id'].'"');
                                    ?>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="tupoksi" name="tupoksi" placeholder="Tupoksi"><?php echo $data['tupoksi']; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolSuntingTupoksi" name="TombolSuntingTupoksi">Simpan</button>
    ...
    echo '
         ...
         ';
    template_js();
    echo '<script src="' . RESOURCES_URL . 'js-for/skp/opd/' . basename($_SERVER['PHP_SELF'], '.php') . '.js"></script>';
    ?>
</body>
