...
check_page_request($_GET['key2'], SKP_URL . 'penilaian-bawahan/');
check_status($koneksi, 'skp_penilaian_bulanan', $_GET['key2']);
			...
			<section class="content">
                <div class="box box-blue">
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?php echo SKP_URL . 'penilaian-bawahan/' . $data_penilaian['id'] . '/'; ?>" class="btn btn-sm btn-default" >Kembali</a>
                    </div>
                </div>
...
if ($data['status'] == 'Diperiksa') {
    ?>
                <div class="box box-blue">
                    <div class="box-header with-border">
                        <h3 class="box-title">Form Verifikasi Penilaian Bulanan</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                        </div>
                    </div>
                    <form class="form-horizontal" id="FormVerifikasiPenilaianBulanan" method="post" action="<?php echo SKP_URL; ?>controllers/c-penilaian-bawahan.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolVerifikasiPenilaianBulanan" name="TombolVerifikasiPenilaianBulanan">Simpan</button>
