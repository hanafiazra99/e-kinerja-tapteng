...
if (isset($_POST['TombolVerifikasiPenilaianBulanan'])) {
    ...
    if ($_POST['tindakan'] == 'Ditolak') {
        $data = array($_POST['id'], '4', $_POST['alasan']);
        ...
        array_push($proses_check, submit_data($koneksi, $data, $field, 'skp_penilaian_bulanan_ttd'));
    }

    if (!in_array("fail", $proses_check)) {
        pop_up_direct(BASE_URL, SKP_URL . 'penilaian-bawahan/' . $data_sasaran['id'] . '/bulanan/' . $_POST['id'] . '/', 'Berhasil', 'Berhasil memverifikasi data.', 'modal-success');
    } else {
        pop_up_direct(BASE_URL, SKP_URL . 'penilaian-bawahan/' . $data_sasaran['id'] . '/bulanan/' . $_POST['id'] . '/', 'Gagal', 'Terjadi kesalahan pada sistem, laporkan ini pada pihak pengembang.', 'modal-danger');
    }
} else if (isset($_POST['TombolSuntingPenilaianBulanan'])) {
    require "../../app/config.php";
    require "../../app/models.php";
    require "../../app/autentikasi.php";
    require "../../app/component.php";
    ...
    if (!in_array("fail", $proses_check)) {
        pop_up_direct(BASE_URL, SKP_URL . 'penilaian-bawahan/' . $data_sasaran_bulanan['sasaran'] . '/bulanan/' . $data_sasaran_bulanan['id'] . '/', 'Berhasil', 'Berhasil Mengubah Nilai.', 'modal-success');
    } else {
        pop_up_direct(BASE_URL, SKP_URL . 'penilaian-bawahan/' . $data_sasaran_bulanan['sasaran'] . '/bulanan/' . $data_sasaran_bulanan['id'] . '/', 'Gagal', 'Terjadi kesalahan pada sistem, laporkan ini pada pihak pengembang.', 'modal-danger');
    }
    ...
    if ($_POST['req'] == 'Change Select') {
        ...
        modal_konfirmasi($_POST['judul'], $_POST['form'], SKP_URL . 'controllers/c-penilaian-bawahan.php', $_POST['pertanyaan'], $_POST['parameter'], $_POST['data']);
    } else if ($_POST['req'] == 'Modal Sunting Data') {
        require "../../app/config.php";
        require "../../app/models.php";
        require "../../app/component.php";

        modal_sunting_data($_POST['judul'], $_POST['form'], SKP_URL . 'controllers/c-penilaian-bawahan.php', $_POST['parameter_pengenal'], $_POST['data_pengenal'], $_POST['parameter_diganti'], $_POST['data_diganti'], $_POST['field']);
    }
}
