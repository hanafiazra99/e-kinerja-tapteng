                    ...
                    <div class="col-md-3">
                        <div class="box box-green">
                            <div class="box-body box-profile text-center">
                                ...
                                <p class="text-muted text-center"><?php echo $data['status_kepegawaian']; ?></p>
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content">
                                <div class="active tab-pane" id="username">
                                    <form class="form-horizontal" id="FormPegawaiSuntingUsername" method="post" action="<?php echo BASE_URL; ?>ekinerja/controllers/c-akun.php">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-push-2 col-sm-3">
                                                <button type="submit" class="btn btn-sm btn-primary" id="TombolPegawaiSuntingUsername" name="TombolPegawaiSuntingUsername">Simpan</button>
                                ...
                                <div class="tab-pane" id="password">
                                    <form class="form-horizontal" id="FormPegawaiSuntingPassword" method="post" action="<?php echo BASE_URL; ?>ekinerja/controllers/c-akun.php">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-push-2 col-sm-3">
                                                <button type="submit" class="btn btn-sm btn-primary" id="TombolPegawaiSuntingPassword" name="TombolPegawaiSuntingPassword">Simpan</button>
                                                <button type="reset" class="btn btn-sm btn-default">Batal</button>
                                            </div>
                                        </div>
                                    </form>
