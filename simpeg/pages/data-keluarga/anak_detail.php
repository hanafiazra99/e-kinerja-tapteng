...
check_page_request($_GET['key1'], SIMPEG_URL . 'data-keluarga/');
$data = req_get_where($koneksi, 'v_pegawai_anak ', 'id = "' . $_GET['key1'] . '"');
$breadcrumb = array('Anak', $data['nama']);
?>
<!DOCTYPE html>
<html>
			...
			<section class="content">
                <div class="box box-blue">
                    ...
                    <div class="box-footer">
                        <a href="<?php echo SIMPEG_URL . 'data-keluarga/'; ?>" class="btn btn-sm btn-default">Kembali</a>
                    </div>
                </div>
			</section>
		</div>
