...
$breadcrumb = array('Unit Organisasi', 'Tambah');
?>
<!DOCTYPE html>
<html>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahUnitOrganisasi" method="post" action="<?php echo SIMPEG_URL;?>controllers/c-profil-opd.php" enctype="multipart/form-data">
                        <div class="box-body">
