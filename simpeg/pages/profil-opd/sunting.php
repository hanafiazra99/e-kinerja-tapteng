...
$data = req_get_where($koneksi, 'opd', 'id = "' . $user_data['opd_id'] . '"');
$breadcrumb = array('Sunting');
?>
<!DOCTYPE html>
<html>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormSuntingOPD" method="post" action="<?php echo SIMPEG_URL;?>controllers/c-profil-opd.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolSuntingOPD" name="TombolSuntingOPD">Simpan</button>
