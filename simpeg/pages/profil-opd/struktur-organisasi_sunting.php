...
check_page_request($_GET['key1'], SIMPEG_URL . 'profil-opd/');
$data = req_get_where($koneksi, 'opd_struktur_organisasi', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'profil-opd/');
$breadcrumb = array('Struktur Organisasi', $data['nama_jabatan'], 'Sunting');
?>
<!DOCTYPE html>
<html>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormSuntingStrukturOrganisasi" method="post" action="<?php echo SIMPEG_URL;?>controllers/c-profil-opd.php" enctype="multipart/form-data">
                    <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php
                                        echo component_select_option_where($koneksi, 'opd_struktur_organisasi', 'id', 'nama_jabatan', 'atasan', 'Atasan', $data['atasan'], 'opd = "'.$user_data['opd_id'].'"');
                                    ?>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <a href="<?php echo SIMPEG_URL.'profil-opd/';?>" class="btn btn-sm btn-default" >Batal</a>
                                </div>
                            </div>
                        </div>
                    </form>
