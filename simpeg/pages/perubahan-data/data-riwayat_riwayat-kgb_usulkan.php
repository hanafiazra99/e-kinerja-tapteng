...
check_page_request($_GET['key1'], SIMPEG_URL . 'perubahan-data/data-riwayat/riwayat-kgb/');
$data = req_get_where($koneksi, 'pegawai_riwayat_kgb', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'perubahan-data/data-riwayat/riwayat-kgb/');
$breadcrumb = array('Data Riwayat', 'Riwayat Pangkat Golongan Ruang', $data['no_sk'], 'Usulkan');
?>
<!DOCTYPE html>
<html>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahUsulanRiwayatKGB" method="post" action="<?php echo SIMPEG_URL;?>controllers/c-perubahan-data.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahUsulanRiwayatKGB" name="TombolTambahUsulanRiwayatKGB">Simpan</button>
