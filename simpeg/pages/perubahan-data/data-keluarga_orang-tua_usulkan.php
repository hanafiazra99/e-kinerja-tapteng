...
$data = req_get_where($koneksi, 'pegawai_ortu', 'id = "' . $_GET['key1'] . '"');
$data_alamat = req_get_where($koneksi, 'pegawai_ortu_alamat', 'id = "' . $_GET['key1'] . '"');
...
$breadcrumb = array('Data Keluarga', 'Orang Tua', $data_pegawai['nama'], 'Usulkan');
?>
<!DOCTYPE html>
<html>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahUsulanOrangTua" method="post" action="<?php echo SIMPEG_URL;?>controllers/c-perubahan-data.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahUsulanOrangTua" name="TombolTambahUsulanOrangTua">Simpan</button>
