...
$data_asn = req_get_where($koneksi, 'pegawai_asn', 'id = "' . $_GET['key1'] . '"');
$data_honorer = req_get_where($koneksi, 'pegawai_honorer', 'id = "' . $_GET['key1'] . '"');
check_page_request($_GET['key1'], SIMPEG_URL . 'perubahan-data/identitas-pegawai/');
$breadcrumb = array('Identitas Pegawai', 'Usulkan', $data['nama']);
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahUsulanPegawaiIdentitas" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-perubahan-data.php" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="nama" class="col-sm-2 control-label">Nama</label>
                                <div class="col-sm-10">
                                    <input type="hidden" class="form-control" id="id" name="id" placeholder="" value="<?php echo $data['id']; ?>" readonly />
                                    <input type="hidden" class="form-control" id="nip" name="nip" placeholder="" value="<?php echo $data_asn['nip']; ?>" readonly />
                                    <input type="hidden" class="form-control" id="status_kepegawaian" name="status_kepegawaian" placeholder="" value="<?php echo $data['status_kepegawaian']; ?>" readonly />
                                    <input type="hidden" class="form-control" id="opd" name="opd" placeholder="" value="<?php echo $data['opd']; ?>" readonly />
...
?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php
echo component_select_option($koneksi, 'opd', 'id', 'nama', 'skpd', 'SKPD', $data['opd']);
?>
                                </div>
                            </div>
                            <div class="form-group">
...
?>
                            ...
                            <div class="form-group" id="konten_jenis_kepegawaian" <?php echo ($data['status_kepegawaian'] == '3' ? 'style="display: none"' : ''); ?>>
                                <label for="jenis_kepegawaian" class="col-sm-2 control-label">Jenis Kepegawaian</label>
                                <div class="col-sm-10">
                                    <?php
echo component_select_option($koneksi, 'ref_jenis_kepegawaian', 'id', 'label', 'jenis_kepegawaian', 'Jenis Kepegawaian', $data_asn['jenis_kepegawaian']);
?>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php
echo component_select_option_where($koneksi, 'ref_kedudukan_pegawai', 'id', 'label', 'kedudukan_pegawai', 'Kedudukan Pegawai', $data['kedudukan_pegawai'], "status_kepegawaian = '" . $data['status_kepegawaian'] . "'");
?>
                                </div>
                            </div>
                            <div class="form-group">
...
?>
                            ...
                            <?php
if ($data['status_kepegawaian'] != '3') {
    echo '
                                        <div class="form-group">
                                            <label for="no_karpeg" class="col-sm-2 control-label">No. KARPEG</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="no_karpeg" name="no_karpeg" placeholder="No. KARPEG" value="' . $data_asn['no_karpeg'] . '" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="no_askes" class="col-sm-2 control-label">No. Kartu ASKES</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="no_askes" name="no_askes" placeholder="No. Kartu ASKES" value="' . $data_asn['no_askes'] . '" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="no_taspen" class="col-sm-2 control-label">No. Kartu TASPEN</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="no_taspen" name="no_taspen" placeholder="No. Kartu TASPEN" value="' . $data_asn['no_taspen'] . '" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="no_karissu" class="col-sm-2 control-label">No. KARIS/KARSU</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="no_karissu" name="no_karissu" placeholder="No. KARIS/KARSU" value="' . $data_asn['no_karissu'] . '" />
                                            </div>
                                        </div>
                                     ';
} else {
    echo '
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control" id="tmt" name="tmt" placeholder="TMT" data-date-format="yyyy-mm-dd" value="' . $data_honorer['tmt'] . '" />
													</div>
												</div>
												<div class="form-group">
													<label for="pendidikan_terakhir" class="col-sm-2 control-label">Pendidikan Terakhir</label>
													<div class="col-sm-10">
														' . component_select_option($koneksi, 'ref_tingkat_pendidikan', 'id', 'label', 'pendidikan_terakhir', 'Pendidikan Terakhir', $data_honorer['pendidikan_terakhir']) . '
													</div>
												</div>
												<div class="form-group">
													<label for="jabatan" class="col-sm-2 control-label">Jabatan</label>
													<div class="col-sm-10">
														' . component_select_option_where($koneksi, 'opd_struktur_organisasi', 'id', 'nama_jabatan', 'jabatan', 'Jabatan', $data_honorer['jabatan'], 'opd = "' . $data['opd'] . '"') . '
													</div>
												</div>
											 ';
}
?>
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahUsulanPegawaiIdentitas" name="TombolTambahUsulanPegawaiIdentitas">Simpan</button>
