...
check_page_request($_GET['key1'], SIMPEG_URL . 'perubahan-data/data-riwayat/riwayat-pgr/');
$data = req_get_where($koneksi, 'v_u_pegawai_riwayat_pgr ', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'perubahan-data/data-riwayat/riwayat-pgr/');
