...
$breadcrumb = array('Data Pegawai', 'Pengangkatan PNS', $data_pegawai['nama'], 'Usulkan');
?>
<!DOCTYPE html>
<html>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahUsulanPengangkatanPNS" method="post" action="<?php echo SIMPEG_URL;?>controllers/c-perubahan-data.php" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="sk_pns" class="col-sm-2 control-label">Surat Keputusan PNS</label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                <label for="icon" class="col-sm-2 control-label">File Surat Keputusan PNS<sup><i class="fa fa-info-circle" data-toggle="tooltip" title="Biarkan ini kosong jika anda tidak ingin mengubah nya"></i></sup></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label for="tmt_pns" class="col-sm-2 control-label">TMT PNS</label>
                                <div class="col-sm-10">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahUsulanPengangkatanPNS" name="TombolTambahUsulanPengangkatanPNS">Simpan</button>
