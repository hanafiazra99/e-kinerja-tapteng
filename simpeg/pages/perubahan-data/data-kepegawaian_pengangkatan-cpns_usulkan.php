...
$data = req_get_where($koneksi, 'pegawai_pengangkatan_cpns', 'id = "' . $_GET['key1'] . '"');
$data_pegawai = req_get_where($koneksi, 'pegawai', 'id = "' . $_GET['key1'] . '"');
$breadcrumb = array('Data Pegawai', 'Pengangkatan CPNS', $data_pegawai['nama'], 'Usulkan');
?>
<!DOCTYPE html>
<html>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahUsulanPengangkatanCPNS" method="post" action="<?php echo SIMPEG_URL;?>controllers/c-perubahan-data.php" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="tgl_nota_bkn" name="tgl_nota_bkn" placeholder="Tanggal" data-date-format="yyyy-mm-dd" value="<?php echo $data['tgl_nota_bkn']?>" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="sk_cpns" class="col-sm-2 control-label">Surat Keputusan CPNS</label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                <label for="icon" class="col-sm-2 control-label">File Surat Keputusan CPNS<sup><i class="fa fa-info-circle" data-toggle="tooltip" title="Biarkan ini kosong jika anda tidak ingin mengubah nya"></i></sup></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <label for="tmt_cpns" class="col-sm-2 control-label">TMT CPNS</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="tmt" name="tmt" placeholder="TMT CPNS" data-date-format="yyyy-mm-dd" value="<?php echo $data['tmt']?>" />
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahUsulanPengangkatanCPNS" name="TombolTambahUsulanPengangkatanCPNS">Simpan</button>
