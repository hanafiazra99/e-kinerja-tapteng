...
$data = req_get_where($koneksi, 'pegawai_riwayat_pgr', 'id = "' . $_GET['key1'] . '"');
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahUsulanRiwayatPGR" method="post" action="<?php echo SIMPEG_URL;?>controllers/c-perubahan-data.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahUsulanRiwayatPGR" name="TombolTambahUsulanRiwayatPGR">Simpan</button>
