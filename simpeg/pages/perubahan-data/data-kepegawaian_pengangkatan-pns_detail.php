...
check_page_request($_GET['key1'], SIMPEG_URL . 'perubahan-data/data-kepegawaian/pengangkatan-pns/');
$data = req_get_where($koneksi, 'v_u_pegawai_pengangkatan_pns', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'perubahan-data/data-kepegawaian/pengangkatan-pns/');
