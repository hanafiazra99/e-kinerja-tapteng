...
$data = req_get_where($koneksi, 'pegawai_riwayat_jabatan', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'perubahan-data/data-riwayat/riwayat-diklat/');
$breadcrumb = array('Data Riwayat', 'Riwayat Pangkat Golongan Ruang', $data['no_sk_jabatan'], 'Usulkan');
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahUsulanRiwayatJabatan" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-perubahan-data.php" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="jenis_jabatan" class="col-sm-2 control-label">OPD</label>
                                <div class="col-sm-10">
...
?>
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahUsulanRiwayatJabatan" name="TombolTambahUsulanRiwayatJabatan">Simpan</button>
