...
require "../../controllers/c-identitas-pegawai.php";

cek_session();
$user_data = user_data($koneksi);
$data = req_get_where($koneksi, 'v_pegawai', 'id = "' . $_SESSION['id'] . '"');
$data_alamat = req_get_where($koneksi, 'v_pegawai_alamat', 'id = "' . $_SESSION['id'] . '"');
$data_asn = req_get_where($koneksi, 'v_pegawai_asn', 'id = "' . $_SESSION['id'] . '"');
$data_honorer = req_get_where($koneksi, 'v_pegawai_honorer', 'id = "' . $_SESSION['id'] . '"');
$breadcrumb = array();
?>
<!DOCTYPE html>
<html>
			...
			<section class="content">
                <div class="box box-blue">
                    <div class="box-header with-border">
                        <h3 class="box-title">Identitas Pegawai</h3>
                    ...
                    <div class="box-footer">
                        <a href="<?php echo SIMPEG_URL . 'perubahan-data/identitas-pegawai/' . $_SESSION['id'] . '/usulkan/' ?>" class="btn btn-sm btn-success">Sunting</a>
                    </div>
                </div>
			</section>
		</div>
