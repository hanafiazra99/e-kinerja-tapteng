...
check_page_request($_GET['key1'], SIMPEG_URL . 'usulan-perubahan-data/data-riwayat/riwayat-pgr/');
check_status($koneksi, 'usulan_pegawai_riwayat_pgr', $_GET['key1']);
$data = req_get_where($koneksi, 'v_pegawai_riwayat_pgr ', 'id = "' . $_GET['key1'] . '"');
$data_u = req_get_where($koneksi, 'v_u_pegawai_riwayat_pgr ', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'usulan-perubahan-data/data-riwayat/riwayat-pgr/');
$breadcrumb = array('Data Riwayat', 'Riwayat Diklat', 'Usulan', $data['no_sk']);
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <section class="content">
                ...
                <div class="box box-blue" <?Php echo ($data_u['status'] == 'Ditolak' ? 'style="display:none;"' : '') ?>>
                    ...
                    <form class="form-horizontal" id="FormVerifikasiRiwayatPGR" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-usulan-perubahan-data.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolVerifikasiRiwayatPGR" name="TombolVerifikasiRiwayatPGR">Simpan</button>
