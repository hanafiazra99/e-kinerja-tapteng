...
check_page_request($_GET['key1'], SIMPEG_URL . 'usulan-perubahan-data/data-kepegawaian/pgr/');
check_status($koneksi, 'usulan_pegawai_kgb', $_GET['key1']);
$data = req_get_where($koneksi, 'v_pegawai_kgb', 'id = "' . $_GET['key1'] . '"');
$data_u = req_get_where($koneksi, 'v_u_pegawai_kgb', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'usulan-perubahan-data/data-kepegawaian/pgr/');
$breadcrumb = array('Data Kepegawaian', 'Kenaikan Gaji Berkala', 'Usulan', $data['pegawai_nama']);
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <div class="row">
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <th>Masa Kerja</th>
                                            <td><?php echo content_masa_kerja($data_u['masa_kerja'])['tahun'] . ' Tahun' . content_masa_kerja($data_u['masa_kerja'])['bulan'] . ' Bulan'; ?></td>
                                        </tr>
                                        <tr>
                                            <th>Kantor Pembayaran</th>
                                            <td><?php echo $data_u['kantor_pembayaran']; ?></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                ...
                <div class="box box-blue" <?Php echo ($data_u['status'] == 'Ditolak' ? 'style="display:none;"' : '') ?>>
                    ...
                    <form class="form-horizontal" id="FormVerifikasiKGB" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-usulan-perubahan-data.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolVerifikasiKGB" name="TombolVerifikasiKGB">Simpan</button>
