...
check_page_request($_GET['key1'], SIMPEG_URL . 'usulan-perubahan-data/data-riwayat/riwayat-pendidikan-umum/');
check_status($koneksi, 'usulan_pegawai_riwayat_pendidikan_umum', $_GET['key1']);
$data = req_get_where($koneksi, 'v_pegawai_riwayat_pendidikan_umum ', 'id = "' . $_GET['key1'] . '"');
$data_u = req_get_where($koneksi, 'v_u_pegawai_riwayat_pendidikan_umum ', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'usulan-perubahan-data/data-riwayat/riwayat-pendidikan-umum/');
...
?>
            ...
            <section class="content">
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <th>Tingkat Pendidikan</th>
                                            <td><?php echo $data_u['tingkat_pendidikan']; ?></td>
                                        </tr>
                                        <tr>
                                            <th>Jurusan</th>
                                            <td><?php echo $data_u['jurusan']; ?></td>
                                        </tr>
                                        <tr>
                                            <th>Institusi</th>
                                            <td>
                                                <i>Nama Institusi:</i> <?php echo $data_u['nama_institusi']; ?><br>
                                                <i>Nama Kepala Institusi:</i> <?php echo $data_u['nama_kepala_institusi']; ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>STTB</th>
                                            <td>
                                                <i>Nomor:</i> <?php echo $data_u['no_sttb']; ?><br>
                                                <i>Tanggal:</i> <?php echo content_tgl_indo($data_u['tgl_sttb']); ?>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                ...
                <div class="box box-blue" <?Php echo ($data_u['status'] == 'Ditolak' ? 'style="display:none;"' : '') ?>>
                    ...
                    <form class="form-horizontal" id="FormVerifikasiRiwayatPendidikanUmum" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-usulan-perubahan-data.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolVerifikasiRiwayatPendidikanUmum" name="TombolVerifikasiRiwayatPendidikanUmum">Simpan</button>
