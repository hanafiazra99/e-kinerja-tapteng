...
check_page_request($_GET['key1'], SIMPEG_URL . 'usulan-perubahan-data/data-kepegawaian/pengangkatan-pns/');
check_status($koneksi, 'usulan_pegawai_pengangkatan_pns', $_GET['key1']);
$data = req_get_where($koneksi, 'v_pegawai_pengangkatan_pns', 'id = "' . $_GET['key1'] . '"');
$data_u = req_get_where($koneksi, 'v_u_pegawai_pengangkatan_pns', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'usulan-perubahan-data/data-kepegawaian/pengangkatan-pns/');
$breadcrumb = array('Data Kepegawaian', 'Pengangkatan PNS', 'Usulan', $data['pegawai_nama']);
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <section class="content">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <i>Tanggal:</i> <?php echo content_tgl_indo($data_u['tgl_sk']); ?>
                ...
                <div class="box box-blue" <?Php echo ($data_u['status'] == 'Ditolak' ? 'style="display:none;"' : '') ?>>
                    ...
                    <form class="form-horizontal" id="FormVerifikasiPengangkatanPNS" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-usulan-perubahan-data.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolVerifikasiPengangkatanPNS" name="TombolVerifikasiPengangkatanPNS">Simpan</button>
