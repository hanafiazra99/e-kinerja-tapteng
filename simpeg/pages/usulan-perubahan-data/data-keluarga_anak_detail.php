...
check_page_request($_GET['key1'], SIMPEG_URL . 'usulan-perubahan-data/data-keluarga/anak/');
check_status($koneksi, 'usulan_pegawai_anak', $_GET['key1']);
$data = req_get_where($koneksi, 'v_pegawai_anak', 'id = "' . $_GET['key1'] . '"');
$data_u = req_get_where($koneksi, 'v_u_pegawai_anak', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'usulan-perubahan-data/data-keluarga/anak/');
...
?>
            ...
            <section class="content">
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <th>Status Anak</th>
                                            <td><?php echo $data_u['status_anak'] ?></td>
                                        </tr>
                                        <tr>
                                            <th>Tunjangan</th>
                                            <td><?php echo $data_u['tunjangan'] ?></td>
                                        </tr>
                                        <tr>
                                            <th>Pendidikan Terakhir</th>
                ...
                <div class="box box-blue" <?Php echo ($data_u['status'] == 'Ditolak' ? 'style="display:none;"' : '') ?>>
                    ...
                    <form class="form-horizontal" id="FormVerifikasiAnak" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-usulan-perubahan-data.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolVerifikasiAnak" name="TombolVerifikasiAnak">Simpan</button>
