...
check_page_request($_GET['key1'], SIMPEG_URL . 'usulan-perubahan-data/data-kepegawaian/jabatan/');
check_status($koneksi, 'usulan_pegawai_jabatan', $_GET['key1']);
$data = req_get_where($koneksi, 'v_pegawai_jabatan', 'id = "' . $_GET['key1'] . '"');
$data_u = req_get_where($koneksi, 'v_u_pegawai_jabatan', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'usulan-perubahan-data/data-kepegawaian/jabatan/');
$breadcrumb = array('Data Kepegawaian', 'Jabatan', 'Usulan', $data['pegawai_nama']);
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <section class="content">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <i>Tanggal:</i> <?php echo content_tgl_indo($data['tgl_sk_pelantikan']); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Sumpah</th>
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <i>Tanggal:</i> <?php echo content_tgl_indo($data_u['tgl_sk_jabatan']); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Jenis Kabatan</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <i>Tanggal:</i> <?php echo content_tgl_indo($data_u['tgl_sk_pelantikan']); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Sumpah</th>
                ...
                <div class="box box-blue" <?Php echo ($data_u['status'] == 'Ditolak' ? 'style="display:none;"' : '') ?>>
                    ...
                    <form class="form-horizontal" id="FormVerifikasiJabatan" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-usulan-perubahan-data.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolVerifikasiJabatan" name="TombolVerifikasiJabatan">Simpan</button>
