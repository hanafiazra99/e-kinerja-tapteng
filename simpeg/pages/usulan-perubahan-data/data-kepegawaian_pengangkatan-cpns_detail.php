...
check_page_request($_GET['key1'], SIMPEG_URL . 'usulan-perubahan-data/data-kepegawaian/pengangkatan-cpns/');
check_status($koneksi, 'usulan_pegawai_pengangkatan_cpns', $_GET['key1']);
$data = req_get_where($koneksi, 'v_pegawai_pengangkatan_cpns', 'id = "' . $_GET['key1'] . '"');
$data_u = req_get_where($koneksi, 'v_u_pegawai_pengangkatan_cpns', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'usulan-perubahan-data/data-kepegawaian/pengangkatan-cpns/');
$breadcrumb = array('Data Kepegawaian', 'Pengangkatan CPNS', 'Usulan', $data['pegawai_nama']);
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <section class="content">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td>
                                                <i>Nomor:</i> <?php echo $data['no_nota_bkn']; ?><br>
                                                <i>Tanggal:</i> <?php echo content_tgl_indo($data['tgl_nota_bkn']); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <th>Surat Keputusan CPNS</th>
                                            <td>
                                                <i>Nomor:</i> <?php echo $data['no_sk']; ?><br>
                                                <i>Tanggal:</i> <?php echo content_tgl_indo($data['tgl_sk']); ?><br>
												<i>Dokumen:</i> <?php echo ($data['file_sk'] != '' ? '<TombolLihatFile judul="Dokumen SK" file="'.RESOURCES_URL.'dokumen/'.$data['id'].'/'.$data['file_sk'].'" class="btn btn-primary btn-xs">Lihat</TombolLihatFile>' : 'Tidak Ada'); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <tr>
                                            <th style="width:25%">Nota Persetujuan BKN</th>
                                            <td>
                                                <i>Nomor:</i> <?php echo $data_u['no_nota_bkn']; ?><br>
                                                <i>Tanggal:</i> <?php echo content_tgl_indo($data_u['tgl_nota_bkn']); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Pejabat Yang Menetapkan</th>
                                        ...
                                        <tr>
                                            <th>Surat Keputusan CPNS</th>
                                            <td>
                                                <i>Nomor:</i> <?php echo $data_u['no_sk']; ?><br>
                                                <i>Tanggal:</i> <?php echo content_tgl_indo($data_u['tgl_sk']); ?><br>
												<i>Dokumen:</i> <?php echo ($data_u['file_sk'] != '' ? '<TombolLihatFile judul="Dokumen SK" file="'.RESOURCES_URL.'dokumen/'.$data['id'].'/'.$data_u['file_sk'].'" class="btn btn-primary btn-xs">Lihat</TombolLihatFile>' : 'Tidak Ada'); ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Pangkat/Golongan/Ruang</th>
                                            <td><?php echo $data_u['pgr']; ?></td>
                                        </tr>
                                        <tr>
                                            <th>TMT CPNS</th>
                ...
                <div class="box box-blue" <?Php echo ($data_u['status'] == 'Ditolak' ? 'style="display:none;"' : '') ?>>
                    ...
                    <form class="form-horizontal" id="FormVerifikasiPengangkatanCPNS" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-usulan-perubahan-data.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolVerifikasiPengangkatanCPNS" name="TombolVerifikasiPengangkatanCPNS">Simpan</button>
