...
$breadcrumb = array('Aparatur Sipil Negara', $data['nama'], 'Riwayat Jabatan', 'Tambah');
?>
<!DOCTYPE html>
<html>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahRiwayatJabatan" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-daftar-pegawai.php" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="no_sk_jabatan" name="no_sk_jabatan" placeholder="Nomor" value="" />
                                </div>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="no_sk_pelantikan" name="no_sk_pelantikan" placeholder="Nomor" value="" />
                                </div>
                                <div class="col-sm-5">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahRiwayatJabatan" name="TombolTambahRiwayatJabatan">Simpan</button>
