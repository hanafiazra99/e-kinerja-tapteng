...
$breadcrumb = array('Pegawai Honorer', 'Tambah');
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahHonorer" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-daftar-pegawai.php" enctype="multipart/form-data">
                        <div class="box-body">
...
?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php
echo component_select_option_where($koneksi, 'opd', 'id', 'nama', 'opd', 'OPD', '', ($_SESSION['role'] == '1' ? '' : 'id = "' . $user_data['opd_id'] . '"'));
?>
                                </div>
                            </div>
                            <div class="form-group">
...
?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php
echo component_select_option($koneksi, 'ref_tingkat_pendidikan', 'id', 'label', 'pendidikan_terakhir', 'Pendidikan Terakhir', '');
?>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php
echo component_select_option_where($koneksi, 'opd_struktur_organisasi', 'id', 'nama_jabatan', 'jabatan', 'Jabatan', '', 'opd = ""');
?>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahHonorer" name="TombolTambahHonorer">Simpan</button>
