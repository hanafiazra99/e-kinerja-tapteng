...
$breadcrumb = array('Aparatur Sipil Negara', $data_pegawai['nama'], 'Mertua', 'Sunting');
?>
<!DOCTYPE html>
<html>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormSuntingMertua" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-daftar-pegawai.php" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="nama" class="col-sm-2 control-label">
                                    <p class="lead control-label">Data Ayah Mertua</p>
                                </label>
                                <div class="col-sm-10">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="nama" class="col-sm-2 control-label">
                                    <p class="lead control-label">Data Ibu Mertua</p>
                                </label>
                                <div class="col-sm-10">
                                </div>
                            </div>
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolSuntingMertua" name="TombolSuntingMertua">Simpan</button>
