...
$breadcrumb = array('Aparatur Sipil Negara', $data['nama'], 'Identitas Pegawai', 'Sunting');
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <section class="content">
				<div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormSuntingIdentitasPegawai" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-daftar-pegawai.php" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control" id="nip" name="nip" placeholder="" value="<?php echo $data_asn['nip']; ?>" />
                                </div>
                            </div>
                            <div class="form-group">
...
?>
                            ...
                            <div class="form-group" id="konten_jenis_kepegawaian">
                                <label for="jenis_kepegawaian" class="col-sm-2 control-label">Status Kepegawaian</label>
                                <div class="col-sm-10">
                                    <select class="form-control select2" id="status_kepegawaian" name="status_kepegawaian" data-placeholder="Status Kepegawaian">
                                        <option value=""></option>
                                        <option value="1" <?php echo ($data['status_kepegawaian'] == '1' ? 'selected' : ''); ?>>Pegawai Negeri Sipil</option>
                                        <option value="2" <?php echo ($data['status_kepegawaian'] == '2' ? 'selected' : ''); ?>>Calon Pegawai Negeri Sipil</option>
                                        <option value="4" <?php echo ($data['status_kepegawaian'] == '4' ? 'selected' : ''); ?>>PPPK</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group" id="konten_jenis_kepegawaian">
...
?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="no_karpeg" name="no_karpeg" placeholder="No. KARPEG" value="<?php echo $data_asn['no_karpeg']; ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="no_askes" class="col-sm-2 control-label">No. Kartu ASKES</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="no_askes" name="no_askes" placeholder="No. Kartu ASKES" value="<?php echo $data_asn['no_askes']; ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="no_taspen" class="col-sm-2 control-label">No. Kartu TASPEN</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="no_taspen" name="no_taspen" placeholder="No. Kartu TASPEN" value="<?php echo $data_asn['no_taspen']; ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="no_karissu" class="col-sm-2 control-label">No. KARIS/KARSU</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="no_karissu" name="no_karissu" placeholder="No. KARIS/KARSU" value="<?php echo $data_asn['no_karissu']; ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolSuntingIdentitasPegawai" name="TombolSuntingIdentitasPegawai">Simpan</button>
