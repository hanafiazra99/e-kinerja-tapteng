...
$data = req_get_where($koneksi, 'v_pegawai_riwayat_pgr ', 'id = "' . $_GET['key2'] . '"');
...
$breadcrumb = array('Aparatur Sipil Negara', $data_pegawai['nama'], 'Riwayat Pangkat Golongan Ruang', $data['no_sk']);
?>
<!DOCTYPE html>
<html>
