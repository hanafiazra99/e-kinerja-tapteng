...
$breadcrumb = array('Aparatur Sipil Negara', $data['nama'], 'Anak', 'Tambah');
?>
<!DOCTYPE html>
<html>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahAnak" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-daftar-pegawai.php" enctype="multipart/form-data">
                    <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php
                                        echo component_select_option($koneksi, 'ref_status_anak', 'id', 'label', 'status_anak', 'Status Anak', '');
                                    ?>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php
                                        echo component_select_option($koneksi, 'ref_tunjangan_anak', 'id', 'label', 'tunjangan', 'Tunjangan', '');
                                    ?>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php
                                        echo component_select_option_with_blank($koneksi, 'ref_tingkat_pendidikan', 'id', 'label', 'pendidikan_terakhir', 'Pendidikan Terakhir', '');
                                    ?>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahAnak" name="TombolTambahAnak">Simpan</button>
