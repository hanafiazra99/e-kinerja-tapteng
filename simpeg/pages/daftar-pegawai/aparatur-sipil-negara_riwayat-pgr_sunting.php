...
$data = req_get_where($koneksi, 'pegawai_riwayat_pgr', 'id = "' . $_GET['key2'] . '"');
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormSuntingRiwayatPGR" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-daftar-pegawai.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolSuntingRiwayatPGR" name="TombolSuntingRiwayatPGR">Simpan</button>
