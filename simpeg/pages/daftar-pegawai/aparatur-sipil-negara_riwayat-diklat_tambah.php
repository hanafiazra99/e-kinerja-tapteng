...
$breadcrumb = array('Aparatur Sipil Negara', $data['nama'], 'Riwayat Diklat', 'Tambah');
?>
<!DOCTYPE html>
<html>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahRiwayatDiklat" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-daftar-pegawai.php" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="no_sttpp" name="no_sttpp" placeholder="Nomor" value="" />
                                </div>
                                <div class="col-sm-5">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahRiwayatDiklat" name="TombolTambahRiwayatDiklat">Simpan</button>
