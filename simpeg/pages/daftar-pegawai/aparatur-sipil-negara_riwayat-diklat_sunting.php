...
$data = req_get_where($koneksi, 'pegawai_riwayat_diklat ', 'id = "' . $_GET['key2'] . '"');
...
$breadcrumb = array('Aparatur Sipil Negara', $data_pegawai['nama'], 'Riwayat Diklat', $data['no_sttpp'], 'Sunting');
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormSuntingRiwayatDiklat" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-daftar-pegawai.php" enctype="multipart/form-data">
                        <div class="box-body">
...
?>
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolSuntingRiwayatDiklat" name="TombolSuntingRiwayatDiklat">Simpan</button>
