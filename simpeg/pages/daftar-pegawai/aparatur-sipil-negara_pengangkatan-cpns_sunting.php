...
$breadcrumb = array('Aparatur Sipil Negara', $data_pegawai['nama'], 'Pengangkatan CPNS', 'Sunting');
?>
<!DOCTYPE html>
<html>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormSuntingPengangkatanCPNS" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-daftar-pegawai.php" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolSuntingPengangkatanCPNS" name="TombolSuntingPengangkatanCPNS">Simpan</button>
