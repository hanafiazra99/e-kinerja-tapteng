...
$breadcrumb = array('Aparatur Sipil Negara', $data['nama'], 'Riwayat Pendidikan Umum', 'Tambah');
?>
<!DOCTYPE html>
<html>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahRiwayatPendidikanUmum" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-daftar-pegawai.php" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <?php
                                        echo component_select_option($koneksi, 'ref_tingkat_pendidikan', 'id', 'label', 'tingkat_pendidikan', 'Tingkat Pendidikan', '');
                                    ?>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="no_sttb" name="no_sttb" placeholder="Nomor" value="" />
                                </div>
                                <div class="col-sm-5">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahRiwayatPendidikanUmum" name="TombolTambahRiwayatPendidikanUmum">Simpan</button>
