...
$data = req_get_where($koneksi, 'ref_kedudukan_pegawai', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'pengaturan/data-pilihan/');
$breadcrumb = array('Data Pilihan', 'Kedudukan Pegawai', $data['label'], 'Sunting');
?>
<!DOCTYPE html>
<html>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormSuntingKedudukanPegawai" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-pengaturan.php" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <?php
                                    echo component_select_option($koneksi, 'ref_status_kepegawaian', 'id', 'label', 'status_kepegawaian', 'Status Kepegawaian', $data['status_kepegawaian']);
                                    ?>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolSuntingKedudukanPegawai" name="TombolSuntingKedudukanPegawai">Simpan</button>
