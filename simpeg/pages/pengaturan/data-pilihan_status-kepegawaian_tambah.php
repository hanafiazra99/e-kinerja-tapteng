...
$breadcrumb = array('Data Pilihan', 'Status Kepegawaian', 'Tambah');
?>
<!DOCTYPE html>
<html>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahStatusKepegawaian" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-pengaturan.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahStatusKepegawaian" name="TombolTambahStatusKepegawaian">Simpan</button>
