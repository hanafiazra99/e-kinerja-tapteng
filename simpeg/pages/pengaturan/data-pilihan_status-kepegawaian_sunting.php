...
$data = req_get_where($koneksi, 'ref_status_kepegawaian', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'pengaturan/data-pilihan/');
$breadcrumb = array('Data Pilihan', 'Status Kepegawaian', $data['label'], 'Sunting');
?>
<!DOCTYPE html>
<html>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormSuntingStatusKepegawaian" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-pengaturan.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolSuntingStatusKepegawaian" name="TombolSuntingStatusKepegawaian">Simpan</button>
