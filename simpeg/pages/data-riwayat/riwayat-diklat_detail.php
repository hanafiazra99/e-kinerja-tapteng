...
$breadcrumb = array('Riwayat Diklat', $data['no_sttpp']);
?>
<!DOCTYPE html>
<html>
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
										...
										<i>Tanggal:</i> <?php echo ($data['file_sttpp'] != '' ? '<TombolLihatFile judul="Dokumen STTPP" file="'.RESOURCES_URL.'dokumen/'.$_SESSION['id'].'/'.$data['file_sttpp'].'" class="btn btn-primary btn-xs">Lihat</TombolLihatFile>' : 'Tidak Ada'); ?>
                                    </td>
                                </tr>
                            </table>
                        </div>
