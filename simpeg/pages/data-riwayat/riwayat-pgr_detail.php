...
$breadcrumb = array('Riwayat Pangkat Golongan Ruang', $data['no_sk']);
?>
<!DOCTYPE html>
<html>
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
										...
										<i>Dokumen:</i> <?php echo ($data['file_sk'] != '' ? '<TombolLihatFile judul="Dokumen SK" file="'.RESOURCES_URL.'dokumen/'.$_SESSION['id'].'/'.$data['file_sk'].'" class="btn btn-primary btn-xs">Lihat</TombolLihatFile>' : 'Tidak Ada'); ?>
                                    </td>
                                </tr>
                                <tr>
