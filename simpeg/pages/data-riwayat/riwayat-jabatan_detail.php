...
check_page_request($_GET['key1'], SIMPEG_URL . 'data-riwayat/');
$data = req_get_where($koneksi, 'v_pegawai_riwayat_jabatan ', 'id = "' . $_GET['key1'] . '"');
$breadcrumb = array('Riwayat Jabatan', $data['no_sk_jabatan']);
?>
<!DOCTYPE html>
<html>
			...
			<section class="content">
                <div class="box box-blue">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
										...
										<i>Dokumen:</i> <?php echo ($data['file_sk_jabatan'] != '' ? '<TombolLihatFile judul="Dokumen SK" file="'.RESOURCES_URL.'dokumen/'.$_SESSION['id'].'/'.$data['file_sk_jabatan'].'" class="btn btn-primary btn-xs">Lihat</TombolLihatFile>' : 'Tidak Ada'); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Jenis Kabatan</th>
                                ...
                                <tr>
                                    ...
                                    <td>
										...
										<i>Dokumen:</i> <?php echo ($data['file_sk_pelantikan'] != '' ? '<TombolLihatFile judul="Dokumen SK" file="'.RESOURCES_URL.'dokumen/'.$_SESSION['id'].'/'.$data['file_sk_pelantikan'].'" class="btn btn-primary btn-xs">Lihat</TombolLihatFile>' : 'Tidak Ada'); ?>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="box-footer">
                        <a href="<?php echo SIMPEG_URL . 'data-riwayat/'; ?>" class="btn btn-sm btn-default">Kembali</a>
                    </div>
                </div>
			</section>
		</div>
