...
$breadcrumb = array('Pendidikan dan Pelatihan', 'Pencantuman Gelar', 'Tambah');
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <div class="box box-blue">
                    ...
                    <form role="form" class="form-horizontal" name="FormTambahPencantumanGelar" id="FormTambahPencantumanGelar" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-layanan-kepegawaian.php" enctype="multipart/form-data">
                        <div class="box-body">
...
?>
                            ...
                            <div class="form-group">
                                <label for="gelar" class="col-sm-2 control-label">Gelar Baru</label>
                                <div class="col-sm-5">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahPencantumanGelar" name="TombolTambahPencantumanGelar">Simpan</button>
