...
check_page_request($_GET['key1'], SIMPEG_URL . 'layanan-kepegawaian/disiplin-penghargaan/cuti/');
($_SESSION['role'] == '1' ? check_status($koneksi, 'simpeg_lp_cuti', $_GET['key1']) : '');
$data = req_get_where($koneksi, 'v_simpeg_lp_cuti', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'layanan-kepegawaian/disiplin-penghargaan/cuti/');
$breadcrumb = array('Disiplin dan Penghargaan', 'Cuti', $data['no_sk']);
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="col-sm-8">
                        <div class="box box-blue">
                            ...
                            <div class="box-body table-responsive">
                                <table class="table">
                                    <tr>
                                        <th style="width:25%">Selama</th>
                                        <td><?php echo $data['lama']; ?> Hari</td>
                                    </tr>
                                    <tr>
                                        <th>Tgl. Mulai</th>
                                        <td><?php echo content_tgl_indo($data['tgl_mulai']); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Tgl. Selesai</th>
                                        <td><?php echo content_tgl_indo($data['tgl_selesai']); ?></td>
                                    </tr>
                                    <tr>
                                        <th>SK</th>
                                        <td></td>
                            ...
                            <div class="box-footer">
                                ...
                                if($data['status'] == 'Disetujui'){
                                   echo  '<a href="cetak-pdf" class="btn btn-sm btn-primary">Cetak Surat Izin</a>';
                                }
                                ?>
                                <TombolHapus judul="Hapus Cuti" formreq="HapusCuti" pertanyaan="Anda yakin ingin menghapus data mutasi ini?<br>Menghapus data akan mengembalikan data sebelumnya, jika status data sudah <b>Disetujui</b>." parameter="id" value="<?php echo $data['id'] ?>" class="btn btn-sm btn-danger">Hapus</TombolHapus>
...
if ($data['status'] == 'Diperiksa') {
    ?>
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormVerifikasiCuti" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-layanan-kepegawaian.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolVerifikasiCuti" name="TombolVerifikasiCuti">Simpan</button>
