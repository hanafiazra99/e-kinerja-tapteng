...
$breadcrumb = array('Disiplin dan Penghargaan', 'Hukuman Disiplin', 'Tambah');
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form role="form" class="form-horizontal" name="FormTambahHukumanDisiplin" id="FormTambahHukumanDisiplin" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-layanan-kepegawaian.php" enctype="multipart/form-data">
                        <div class="box-body">
...
?>
                            ...
                            <div class="form-group">
                                <label for="sumber" class="col-sm-2 control-label">Tingkat Hukuman Disiplin</label>
                                <div class="col-sm-10">
<?php
echo component_select_option_where($koneksi, 'ref_tingkat_hukuman_disiplin', 'id', 'label', 'tingkat_hukuman', 'Tingkat Hukuman Disiplin', '', "id != ''");
?>
                                </div>
                            </div>
                            <div class="form-group" style="display: none;" id="container_diberhentikan">
                                <label for="sumber" class="col-sm-2 control-label">Diberhentikan</label>
                                <div class="col-sm-10">
                                    <select class="form-control select2" name="diberhentikan" id="diberhentikan" data-placeholder="Diberhentikan" style="width: 100% !important;">
                                        <option></option>
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahHukumanDisiplin" name="TombolTambahHukumanDisiplin">Simpan</button>
