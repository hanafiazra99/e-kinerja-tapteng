...
check_page_request($_GET['key1'], SIMPEG_URL . 'layanan-kepegawaian/perencanaan-pemberhentian/masa-persiapan-pensiun/');
$data = req_get_where($koneksi, 'v_simpeg_lp_masa_persiapan_pensiun', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'layanan-kepegawaian/perencanaan-pemberhentian/masa-persiapan-pensiun/');
$breadcrumb = array('Perencanaan dan Pemberhentian', 'Masa Persiapan Pensiun', $data['no_sk']);
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="col-sm-8">
                        <div class="box box-blue">
                            ...
                            <div class="box-body table-responsive">
                                <table class="table">
                                    <tr>
                                        <th style="width:25%">Pangkat/Golongan/Ruang</th>
                            ...
                            <div class="box-footer">
                                <TombolHapus judul="Hapus Masa Persiapan Pensiun" formreq="HapusMasaPersiapanPensiun" pertanyaan="Anda yakin ingin menghapus data persiapan pensiun ini?<br>Menghapus data ini akan mengembalikan kedudukan aktif kepada pegawai." parameter="id" value="<?php echo $data['id'] ?>" class="btn btn-sm btn-danger">Hapus</TombolHapus>
