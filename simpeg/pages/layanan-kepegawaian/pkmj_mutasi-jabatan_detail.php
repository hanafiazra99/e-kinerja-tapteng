...
($_SESSION['role'] == '1' ? check_status($koneksi, 'simpeg_lp_mutasi_jabatan', $_GET['key1']) : '');
$data = req_get_where($koneksi, 'v_simpeg_lp_mutasi_jabatan', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'layanan-kepegawaian/pkmj/mutasi-jabatan/');
$breadcrumb = array('PKMJ', 'Mutasi Jabatan', $data['no_sk_jabatan']);
?>
<!DOCTYPE html>
<html>
                            ...
                            <div class="box-body table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $data['unit_organisasi']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Jenis Kabatan</th>
...
if ($data['status'] == 'Diperiksa') {
    ?>
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormVerifikasiMutasiJabatan" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-layanan-kepegawaian.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolVerifikasiMutasiJabatan" name="TombolVerifikasiMutasiJabatan">Simpan</button>
