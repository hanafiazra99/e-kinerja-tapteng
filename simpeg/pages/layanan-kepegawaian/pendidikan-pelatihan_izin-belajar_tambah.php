...
$breadcrumb = array('Pendidikan dan Pelatihan', 'Izin Belajar', 'Tambah');
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <div class="box box-blue">
                    ...
                    <form role="form" class="form-horizontal" name="FormTambahIzinBelajar" id="FormTambahIzinBelajar" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-layanan-kepegawaian.php" enctype="multipart/form-data">
                        <div class="box-body">
...
?>
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahIzinBelajar" name="TombolTambahIzinBelajar">Simpan</button>
