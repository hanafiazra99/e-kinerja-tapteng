...
$breadcrumb = array('Pendidikan dan Pelatihan', 'Tugas Belajar', 'Tambah');
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <div class="box box-blue">
                    ...
                    <form role="form" class="form-horizontal" name="FormTambahTugasBelajar" id="FormTambahTugasBelajar" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-layanan-kepegawaian.php" enctype="multipart/form-data">
                        <div class="box-body">
...
?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="institusi" name="institusi" placeholder="Institusi" value="" />
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahTugasBelajar" name="TombolTambahTugasBelajar">Simpan</button>
