...
$breadcrumb = array('Pendidikan dan Pelatihan', 'Diklat', 'Tambah');
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <div class="box box-blue">
                    ...
                    <form role="form" class="form-horizontal" name="FormTambahDiklat" id="FormTambahDiklat" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-layanan-kepegawaian.php" enctype="multipart/form-data">
                        <div class="box-body">
...
?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php
echo component_select_option($koneksi, 'ref_jenis_diklat', 'id', 'label', 'jenis_diklat', 'Jenis Diklat', '');
?>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama_diklat" id="nama_diklat" placeholder="Nama Diklat" value="" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="penyelenggara" class="col-sm-2 control-label">Penyelenggara</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="penyelenggara" name="penyelenggara" placeholder="Penyelenggara" value="" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="angkatan" class="col-sm-2 control-label">Angkatan</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="angkatan" name="angkatan" placeholder="Angkatan" value="" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="lama_pendidikan" class="col-sm-2 control-label">Lama Pendidikan</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="lama_pendidikan_h" name="lama_pendidikan_h" placeholder="Hari" value="" />
                                    <i class="text-info">Kosongkan jika tidak lebih dari 1 hari</i>
                                </div>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="lama_pendidikan_j" name="lama_pendidikan_j" placeholder="Jam" value="" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="sttpp" class="col-sm-2 control-label">STTPP</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="no_sttpp" name="no_sttpp" placeholder="Nomor" value="" /><br>
                                    <input type="text" class="form-control" id="tgl_sttpp" name="tgl_sttpp" placeholder="Tanggal" data-date-format="yyyy-mm-dd" value="" />
                                </div>
                                <div class="col-sm-5">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahDiklat" name="TombolTambahDiklat">Simpan</button>
