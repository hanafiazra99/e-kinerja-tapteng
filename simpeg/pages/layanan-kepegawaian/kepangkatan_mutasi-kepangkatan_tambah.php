...
$breadcrumb = array('Kepangkatan', 'Mutasi Kepangkatan', 'Tambah');
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form role="form" class="form-horizontal" name="FormTambahMutasiKepangkatan" id="FormTambahMutasiKepangkatan" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-layanan-kepegawaian.php" enctype="multipart/form-data">
                        <div class="box-body">
...
?>
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahMutasiKepangkatan" name="TombolTambahMutasiKepangkatan">Simpan</button>
