...
$breadcrumb = array('Perencanaan dan Pemberhentian', 'Pensiun', 'Tambah');
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form role="form" class="form-horizontal" name="FormTambahPensiun" id="FormTambahPensiun" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-layanan-kepegawaian.php" enctype="multipart/form-data">
                        <div class="box-body">
...
?>
                            ...
                            <div class="form-group">
                                <label for="sumber" class="col-sm-2 control-label">Pangkat/Golongan/Ruang Baru</label>
                                <div class="col-sm-10">
<?php
echo component_select_option_custom_field($koneksi, 'ref_pgr', 'id', array('pangkat', 'golongan', 'ruang'), 'pgr', 'Pangkat/Golongan/Ruang Baru', '', array('/', '/', ''))
?>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="pym" name="pym" placeholder="Pejabat Yang Menetapkan" value="" /><br>
                                    <input type="text" class="form-control" id="no_sk" name="no_sk" placeholder="Nomor" value="" /><br>
                                    <input type="text" class="form-control" id="tgl_sk" name="tgl_sk" placeholder="Tanggal" data-date-format="yyyy-mm-dd" value="" /><br>
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahPensiun" name="TombolTambahPensiun">Simpan</button>
