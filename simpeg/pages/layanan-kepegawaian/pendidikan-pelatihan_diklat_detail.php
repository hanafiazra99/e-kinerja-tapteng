...
check_page_request($_GET['key1'], SIMPEG_URL . 'layanan-kepegawaian/pendidikan-pelatihan/diklat/');
($_SESSION['role'] == '1' ? check_status($koneksi, 'simpeg_lp_diklat', $_GET['key1']) : '');
$data = req_get_where($koneksi, 'v_simpeg_lp_diklat', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'layanan-kepegawaian/pendidikan-pelatihan/diklat/');
$breadcrumb = array('Pendidikan dan Pelatihan', 'Diklat', $data['no_sk']);
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="col-sm-8">
                        <div class="box box-blue">
                            ...
                            <div class="box-body table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo ($data['lama_pendidikan_h'] != 0 ? $data['lama_pendidikan_h'] . ' Hari ' : '') . ($data['lama_pendidikan_j'] != 0 ? $data['lama_pendidikan_j'] . ' Jam' : ''); ?></td>
                                    </tr>
                                    <tr>
                                        <th>STTPP</th>
                                        <td></td>
                                    ...
                                    <tr>
                                        <th>No. STTPP</th>
                                        <td><?php echo $data['no_sttpp']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Tgl. STTPP</th>
                                        <td><?php echo content_tgl_indo($data['tgl_sttpp']); ?></td>
                                    </tr>
                                    <tr>
                                        <th>SK</th>
                                        <td></td>
                            ...
                            <div class="box-footer">
                                ...
                                <TombolHapus judul="Hapus Mutasi Jabatan" formreq="HapusDiklat" pertanyaan="Anda yakin ingin menghapus data mutasi ini?<br>Menghapus data akan mengembalikan data sebelumnya, jika status data sudah <b>Disetujui</b>." parameter="id" value="<?php echo $data['id'] ?>" class="btn btn-sm btn-danger">Hapus</TombolHapus>
...
if ($data['status'] == 'Diperiksa') {
    ?>
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormVerifikasiDiklat" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-layanan-kepegawaian.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolVerifikasiDiklat" name="TombolVerifikasiDiklat">Simpan</button>
