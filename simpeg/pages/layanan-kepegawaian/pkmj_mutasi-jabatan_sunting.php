...
$data = req_get_where($koneksi, 'simpeg_lp_mutasi_jabatan', 'id = "' . $_GET['key1'] . '"');
$status = ($data['status'] == 'Disetujui' ? '' : 'Ok');
check_page_request($data['id'], SIMPEG_URL . 'layanan-kepegawaian/pkmj/mutasi-jabatan/');
check_page_request($status, SIMPEG_URL . 'layanan-kepegawaian/pkmj/mutasi-jabatan/' . $data['id'] . '/');
$breadcrumb = array('PKMJ', 'Mutasi Jabatan', $data['no_sk_jabatan'], 'Sunting');
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form role="form" class="form-horizontal" name="FormSuntingMutasiJabatan" id="FormSuntingMutasiJabatan" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-layanan-kepegawaian.php" enctype="multipart/form-data">
                        <div class="box-body">
...
?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
<?php
echo component_select_option($koneksi, 'opd', 'id', 'nama', 'opd_baru', 'Pilih OPD', $data['opd']);
?>
                                </div>
                                <div class="col-sm-5">
<?php
echo component_select_option_where($koneksi, 'opd_unit_organisasi', 'id', 'nama', 'unit_organisasi_baru', 'Pilih Unit Organisasi', $data['unit_organisasi'], 'opd = "' . $data['opd'] . '"');
?>
                                </div>
                            </div>
                            <div class="form-group">
...
?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
<?php
echo component_select_option_where($koneksi, 'opd_struktur_organisasi', 'id', 'nama_jabatan', 'jabatan_baru', 'Jabatan Baru', $data['nama_jabatan'], 'opd = "' . $data['opd'] . '"');
?>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="pym" id="pym" placeholder="Pejabat Yang Menetapkan" value="<?php echo $data['pym']; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="no_sk_jabatan" name="no_sk_jabatan" placeholder="Nomor" value="<?php echo $data['no_sk_jabatan']; ?>" /><br>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="hidden" class="form-control" id="file_sk_jabatan_l" name="file_sk_jabatan_l" value="<?php echo $data['file_sk_jabatan']; ?>" readonly />
                                </div>
                                <div class="col-sm-1">
                                    <i class="fa fa-info-circle" data-toggle="tooltip" title="Biarkan ini kosong jika anda tidak ingin mengubah nya"></i>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="sk_pelantikan" class="col-sm-2 control-label">SK Pelantikan</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="no_sk_pelantikan" name="no_sk_pelantikan" placeholder="Nomor" value="<?php echo $data['no_sk_pelantikan']; ?>" /><br>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="hidden" class="form-control" id="file_sk_pelantikan_l" name="file_sk_pelantikan_l" value="<?php echo $data['file_sk_pelantikan']; ?>" readonly />
                                </div>
                                <div class="col-sm-1">
                                    <i class="fa fa-info-circle" data-toggle="tooltip" title="Biarkan ini kosong jika anda tidak ingin mengubah nya"></i>
                                </div>
...
?>
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolSuntingMutasiJabatan" name="TombolSuntingMutasiJabatan">Simpan</button>
