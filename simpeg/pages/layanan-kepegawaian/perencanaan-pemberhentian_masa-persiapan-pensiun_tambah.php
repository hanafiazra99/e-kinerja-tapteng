...
$breadcrumb = array('Perencanaan dan Pemberhentian', 'Masa Persiapan Pensiun', 'Tambah');
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form role="form" class="form-horizontal" name="FormTambahMasaPersiapanPensiun" id="FormTambahMasaPersiapanPensiun" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-layanan-kepegawaian.php" enctype="multipart/form-data">
                        <div class="box-body">
...
?>
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahMasaPersiapanPensiun" name="TombolTambahMasaPersiapanPensiun">Simpan</button>
