...
check_page_request($_GET['key1'], SIMPEG_URL . 'layanan-kepegawaian/kepangkatan/mutasi-gaji-berkala/');
($_SESSION['role'] == '1' ? check_status($koneksi, 'simpeg_lp_mutasi_kgb', $_GET['key1']) : '');
$data = req_get_where($koneksi, 'v_simpeg_lp_mutasi_kgb', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'layanan-kepegawaian/kepangkatan/mutasi-gaji-berkala/');
$breadcrumb = array('Kepangkatan', 'Mutasi Gaji Berkala', $data['no_sk']);
?>
<!DOCTYPE html>
<html>
...
if ($data['status'] == 'Diperiksa') {
    ?>
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormVerifikasiMutasiGajiBerkala" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-layanan-kepegawaian.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolVerifikasiMutasiGajiBerkala" name="TombolVerifikasiMutasiGajiBerkala">Simpan</button>
