...
check_page_request($_GET['key1'], SIMPEG_URL . 'layanan-kepegawaian/pendidikan-pelatihan/penyesuaian-ijazah/');
($_SESSION['role'] == '1' ? check_status($koneksi, 'simpeg_lp_penyesuaian_ijazah', $_GET['key1']) : '');
$data = req_get_where($koneksi, 'v_simpeg_lp_penyesuaian_ijazah', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'layanan-kepegawaian/pendidikan-pelatihan/penyesuaian-ijazah/');
$breadcrumb = array('Pendidikan dan Pelatihan', 'Penyesuaian Ijazah');
?>
<!DOCTYPE html>
<html>
                        ...
                        <div class="box box-blue">
                            ...
                            <div class="box-body table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <th>Nama Kepala Institusi</th>
                                        <td><?php echo $data['nama_kepala_institusi']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>STTB</th>
                                        <td></td>
                                    ...
                                    <tr>
                                        <th>No. STTB</th>
                                        <td><?php echo $data['no_sttb']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Tgl. STTB</th>
                                        <td><?php echo content_tgl_indo($data['tgl_sttb']); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Keterangan</th>
                            ...
                            <div class="box-footer">
                                ...
                                <TombolHapus judul="Hapus Mutasi Jabatan" formreq="HapusPenyesuaianIjazah" pertanyaan="Anda yakin ingin menghapus data mutasi ini?<br>Menghapus data akan mengembalikan data sebelumnya, jika status data sudah <b>Disetujui</b>." parameter="id" value="<?php echo $data['id'] ?>" class="btn btn-sm btn-danger">Hapus</TombolHapus>
...
if ($data['status'] == 'Diperiksa') {
    ?>
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormVerifikasiPenyesuaianIjazah" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-layanan-kepegawaian.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolVerifikasiPenyesuaianIjazah" name="TombolVerifikasiPenyesuaianIjazah">Simpan</button>
