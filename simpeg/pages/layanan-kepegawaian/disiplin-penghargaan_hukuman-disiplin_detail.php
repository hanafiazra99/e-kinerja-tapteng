...
check_page_request($_GET['key1'], SIMPEG_URL . 'layanan-kepegawaian/disiplin-penghargaan/hukuman-disiplin/');
($_SESSION['role'] == '1' ? check_status($koneksi, 'simpeg_lp_hukuman_disiplin', $_GET['key1']) : '');
$data = req_get_where($koneksi, 'v_simpeg_lp_hukuman_disiplin', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'layanan-kepegawaian/disiplin-penghargaan/hukuman-disiplin/');
$breadcrumb = array('Disiplin dan Penghargaan', 'Hukuman Disiplin', $data['no_sk']);
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="col-sm-8">
                        <div class="box box-blue">
                            ...
                            <div class="box-body table-responsive">
                                <table class="table">
                                    <tr>
                                        <th style="width:25%">Tingkat Hukuman Disiplin</th>
                                        <td><?php echo $data['tingkat_hukuman_disiplin']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Diberhentikan</th>
                                        <td><?php echo $data['diberhentikan']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>SK</th>
                                        <td></td>
                            ...
                            <div class="box-footer">
                                ...
                                <TombolHapus judul="Hapus Hukuman Disiplin" formreq="HapusHukumanDisiplin" pertanyaan="Anda yakin ingin menghapus data mutasi ini?<br>Menghapus data akan mengembalikan data sebelumnya, jika status data sudah <b>Disetujui</b>." parameter="id" value="<?php echo $data['id'] ?>" class="btn btn-sm btn-danger">Hapus</TombolHapus>
...
if ($data['status'] == 'Diperiksa') {
    ?>
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormVerifikasiHukumanDisiplin" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-layanan-kepegawaian.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolVerifikasiHukumanDisiplin" name="TombolVerifikasiHukumanDisiplin">Simpan</button>
