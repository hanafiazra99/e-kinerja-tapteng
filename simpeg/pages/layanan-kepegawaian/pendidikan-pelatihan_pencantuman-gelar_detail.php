...
check_page_request($_GET['key1'], SIMPEG_URL . 'layanan-kepegawaian/pendidikan-pelatihan/pencantuman-gelar/');
($_SESSION['role'] == '1' ? check_status($koneksi, 'simpeg_lp_pencantuman_gelar', $_GET['key1']) : '');
$data = req_get_where($koneksi, 'v_simpeg_lp_pencantuman_gelar', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'layanan-kepegawaian/pendidikan-pelatihan/pencantuman-gelar/');
$breadcrumb = array('Pendidikan dan Pelatihan', 'Pencantuman Gelar', $data['no_sk']);
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="col-sm-8">
                        <div class="box box-blue">
                            ...
                            <div class="box-body table-responsive">
                                <table class="table">
                                    <tr>
                                        <th style="width:25%">Gelar Lama</th>
                                        <td><?php echo $data['gelar_lama']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Gelar Baru</th>
                                        <td><?php echo $data['gelar_baru']; ?></td>
                                    </tr>
                                    <tr>
                                        <th>SK</th>
                                        <td></td>
                            ...
                            <div class="box-footer">
                                ...
                                <TombolHapus judul="Hapus Mutasi Jabatan" formreq="HapusPencantumanGelar" pertanyaan="Anda yakin ingin menghapus data mutasi ini?<br>Menghapus data akan mengembalikan data sebelumnya, jika status data sudah <b>Disetujui</b>." parameter="id" value="<?php echo $data['id'] ?>" class="btn btn-sm btn-danger">Hapus</TombolHapus>
...
if ($data['status'] == 'Diperiksa') {
    ?>
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormVerifikasiPencantumanGelar" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-layanan-kepegawaian.php" enctype="multipart/form-data">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolVerifikasiPencantumanGelar" name="TombolVerifikasiPencantumanGelar">Simpan</button>
