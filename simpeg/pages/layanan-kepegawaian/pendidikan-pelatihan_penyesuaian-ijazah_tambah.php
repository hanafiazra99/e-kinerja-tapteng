...
$breadcrumb = array('Pendidikan dan Pelatihan', 'Penyesuaian Ijazah', 'Tambah');
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <div class="box box-blue">
                    ...
                    <form role="form" class="form-horizontal" name="FormTambahPenyesuaianIjazah" id="FormTambahPenyesuaianIjazah" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-layanan-kepegawaian.php" enctype="multipart/form-data">
                        <div class="box-body">
...
?>
                            ...
                            <div class="form-group">
                                <label for="sumber" class="col-sm-2 control-label">Tingkat Pendidikan</label>
                                <div class="col-sm-10">
<?php
echo component_select_option_where($koneksi, 'ref_tingkat_pendidikan', 'id', 'label', 'tingkat_pendidikan', 'Tingkat Pendidikan', '', "id != ''");
?>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="jurusan" name="jurusan" placeholder="Jurusan" value="" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="institusi" class="col-sm-2 control-label">Institusi</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="nama_institusi" name="nama_institusi" placeholder="Nama Institusi" value="" />
                                </div>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="nama_kepala_institusi" name="nama_kepala_institusi" placeholder="Nama Kepala Institusi" value="" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="sk_pns" class="col-sm-2 control-label">STTB</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="no_sttb" name="no_sttb" placeholder="Nomor" value="" /><br>
                                    <input type="text" class="form-control" id="tgl_sttb" name="tgl_sttb" placeholder="Tanggal" data-date-format="yyyy-mm-dd" value="" />
                                </div>
                                <div class="col-sm-5">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahPenyesuaianIjazah" name="TombolTambahPenyesuaianIjazah">Simpan</button>
