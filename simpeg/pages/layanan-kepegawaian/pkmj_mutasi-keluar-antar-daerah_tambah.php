...
$breadcrumb = array('PKMJ', 'Mutasi Keluar Antar Daerah', 'Tambah');
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form role="form" class="form-horizontal" name="FormTambahMutasiKeluarDaerah" id="FormTambahMutasiKeluarDaerah" method="post" action="<?php echo SIMPEG_URL; ?>controllers/c-layanan-kepegawaian.php" enctype="multipart/form-data">
                        <div class="box-body">
...
?>
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahMutasiKeluarDaerah" name="TombolTambahMutasiKeluarDaerah">Simpan</button>
