            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?php echo SIMPEG_URL; ?>opd/" class="btn btn-sm btn-default">Kembali</a>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="box box-blue">
                            <div class="box-header with-border">
                                <h3 class="box-title">Daftar Unit Organisasi</h3>
                                <div class="box-tools pull-right">
...
template_js();
echo '
            <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAb7l_bI3jrels9F6B45YSmcGxKr7wM_6M"></script>
            <script src="' . RESOURCES_URL . 'js-for/simpeg/opd/' . basename($_SERVER['PHP_SELF'], '.php') . '.js"></script>
         ';
?>
</body>
