...
$breadcrumb = array($data['nama'], 'Sunting');
?>
<!DOCTYPE html>
<html>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormSuntingOPD" method="post" action="<?php echo SIMPEG_URL;?>controllers/c-opd.php" enctype="multipart/form-data">
                        <div class="box-body">
