...
$breadcrumb = array($data['nama'], 'Struktur Organisasi', 'Tambah');
?>
<!DOCTYPE html>
<html>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahStrukturOrganisasi" method="post" action="<?php echo SIMPEG_URL;?>controllers/c-opd.php" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php
                                        echo component_select_option_where($koneksi, 'opd_struktur_organisasi', 'id', 'nama_jabatan', 'atasan', 'Atasan', '', 'opd = "'.$data['id'].'"');
                                    ?>
                                </div>
                            </div>
                            <div class="form-group">
