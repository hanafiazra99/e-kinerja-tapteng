...
$breadcrumb = array($data['nama'], 'Unit Organisasi', 'Tambah');
?>
<!DOCTYPE html>
<html>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormTambahUnitOrganisasi" method="post" action="<?php echo SIMPEG_URL;?>controllers/c-opd.php" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="tlp" name="tlp" placeholder="No. Telepon" value="" />
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <button type="submit" class="btn btn-sm btn-primary" id="TombolTambahUnitOrganisasi" name="TombolTambahUnitOrganisasi">Simpan</button>
