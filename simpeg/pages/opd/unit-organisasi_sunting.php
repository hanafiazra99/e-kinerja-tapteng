...
$data = req_get_where($koneksi, 'opd_unit_organisasi', 'id = "' . $_GET['key2'] . '"');
$data_opd = req_get_where($koneksi, 'opd', 'id = "' . $_GET['key1'] . '"');
check_page_request($data['id'], SIMPEG_URL . 'opd/');
$breadcrumb = array($data_opd['nama'], 'Unit Organisasi', $data['nama'], 'Sunting');
?>
<!DOCTYPE html>
<html>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-blue">
                    ...
                    <form class="form-horizontal" id="FormSuntingUnitOrganisasi" method="post" action="<?php echo SIMPEG_URL;?>controllers/c-opd.php" enctype="multipart/form-data">
                        <div class="box-body">
